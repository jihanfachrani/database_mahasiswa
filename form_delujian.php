...
include "koneksi.php";
$cari = $_GET["id"];
$query = "SELECT * FROM tbl_ujian where nim='$cari'";   
...
<tr>
	<td align="right"><font face="verdana" size="2" color="yellow"><b>UTS</td>
	<td align="center"><font face="verdana" size="1" color="yellow"><b>:</td>
	<td><font size="2" color="blue"><b><?php echo $uts;?></b></font></td>
</tr>
<tr>
	<td align="right"><font face="verdana" size="2" color="yellow"><b>UAS</td>
	<td align="center"><font face="verdana" size="1" color="yellow"><b>:</td>
...
<a href="proses_delujian.php?id=<?php echo $nim;?>" style="text-decoration:none">
<font color="darkred" face="calibri" size="4"><b>YA</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="ujian.php" style="text-decoration:none">
