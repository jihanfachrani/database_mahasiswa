...
<table width="100%" border="0">>
		...
		<tr align=left>
			...
			<tr>
				<td width=50%><font face="verdana" size="1" color="pink"><b>Nama Mahasiswa</td>
				<td><font face="verdana" size="1" color="pink"><b>:</td>
				<td colspan=2><input type="text" name="vnama" size="22"></td>
			</tr>
			<tr>
				<td width=50%><font face="verdana" size="1" color="pink"><b>Kota</td>
				<td><font face="verdana" size="1" color="pink"><b>:</td>
				<td colspan=2><input type="text" name="vkota" size="22"></td>
			</tr>
			<tr>
				<td colspan=2>&nbsp;</td>
