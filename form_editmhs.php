...
<tr>
	<td align="right"><font face="verdana" size="1" color="yellow"><b>NIM</td>
...
<tr>
	...
	<td align="right"><font face="verdana" size="1" color="yellow"><b>:</td>
	<td><input type="text" name="vnama" value="<?php echo $nama;?>"</td>
</tr>
<tr>
	<td align="right"><font face="verdana" size="1" color="yellow"><b>Kota</td>
	<td align="right"><font face="verdana" size="1" color="yellow"><b>:</td>
	<td><input type="text" name="vkota" value="<?php echo $kota;?>"</td>
</tr>
<tr>
	<td colspan=2>&nbsp;</td>
