...
<table width="100%" border="0">>
		...
		<tr align=left>
			...
			<tr>
				<td><font face="verdana" size="1" color="pink"><b>KODEMK</td>
				<td><font face="verdana" size="1" color="pink"><b>:</td>
				<td colspan=2><input type="text" name="vkodemk" size="22" color=silver></td>
			</tr>
			<tr>
				<td width=50%><font face="verdana" size="1" color="pink"><b>Nama MATKUL</td>
				<td><font face="verdana" size="1" color="pink"><b>:</td>
				<td colspan=2><input type="text" name="vnama" size="22"></td>
			</tr>
            <tr>
				<td width=50%><font face="verdana" size="1" color="pink"><b>SKS</td>
				<td><font face="verdana" size="1" color="pink"><b>:</td>
				<td colspan=2><input type="text" name="vsks" size="22"></td>
			</tr>
			<tr>
				<td colspan=2>&nbsp;</td>
