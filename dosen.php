...
<td align=center><font face=calibri size=2 color=white><b>NID</b></font></td>
...
<td align=center><font face=arial size=1 color=black><b><?php echo $data['nid'];?></b></font></td>
<td align=left><font face=verdana size=1 class="yellowblack"><b><?php echo $data['nama'];?></b></font></td>

<td align=center width="16%"> <a href="form_editdos.php?id=<?php echo $data['nid'];?>" style="text-decoration:none">
<img src="edit1.png" width="20"></a>&nbsp;
<a href="form_deldos.php?id=<?php echo $data['nid'];?>" style="text-decoration:none"><img src="delete1.png" width="24"></a>
</td>
</tr>
...
<tr valign=middle height=19>
<td colspan=3>&nbsp;</td>
<td align="center">	<a href="form_adddos.php" style="text-decoration:none"><br><img src="add.png" width="25"></a></td>
</tr>
</table>
<!– END ISI -->
